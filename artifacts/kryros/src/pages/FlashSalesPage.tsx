  ...
  return (
    <div className="flex flex-col min-h-screen pb-16 md:pb-0">
      ...
      <section className="py-12 px-4 md:px-8 max-w-screen-md mx-auto w-full mb-12 text-center">
        <div className="border-2 border-primary/30 bg-primary/5 rounded-3xl p-8 md:p-12">
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
            ...
            <Button type="submit" className="h-12 rounded-full px-8 gradient-hero text-white font-bold">
              Notify Me
            </Button>
          </form>
        </div>
