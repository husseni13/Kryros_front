...
export default function FinancingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen pb-16 md:pb-0">
      ...
      {/* Hero */}
      <section className="gradient-hero py-20 px-4 md:px-8 text-white relative overflow-hidden">
        <div className="max-w-screen-2xl mx-auto relative z-10 text-center space-y-6">
          ...
          <p className="text-xl md:text-2xl font-medium max-w-2xl mx-auto text-white/80">
      ...
      <section className="py-16 px-4 md:px-8 max-w-screen-2xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={item.step} className="bg-card border border-border p-8 rounded-3xl text-center relative overflow-hidden group hover:border-primary transition-colors">
      ...
      <section className="py-16 px-4 md:px-8 max-w-screen-2xl mx-auto w-full bg-muted/20 border-y border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          {/* Standard */}
          <div className="bg-card border-2 border-primary p-8 rounded-3xl flex flex-col relative transform md:-translate-y-4 shadow-brand">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 gradient-hero text-white font-bold text-xs px-4 py-1 rounded-full">
              MOST POPULAR
            </div>
            <h3 className="text-xl font-bold mb-2">Standard</h3>
            <div className="text-3xl font-bold mb-6 text-primary">up to $1,000</div>
            <ul className="space-y-3 mb-8 flex-1">
              <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-primary" /> 4.5% p.a. interest</li>
              <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-primary" /> Up to 12 months</li>
              <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-primary" /> Income verification</li>
            </ul>
            <Button className="w-full rounded-full h-12 gradient-hero text-white font-bold">Apply for Standard</Button>
          </div>
          ...
          <div className="bg-card border border-border p-8 rounded-3xl flex flex-col">
            ...
            <ul className="space-y-3 mb-8 flex-1">
              <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-primary" /> 3.5% p.a. interest</li>
              <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-primary" /> Up to 36 months</li>
              <li className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-primary" /> Full credit check</li>
            </ul>
