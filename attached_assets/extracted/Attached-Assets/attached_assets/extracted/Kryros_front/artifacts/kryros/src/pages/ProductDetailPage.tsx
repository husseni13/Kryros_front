        ...
        <div className="w-full lg:w-1/2 flex flex-col">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-border">
              ...
              <Button size="lg" className="flex-1 h-14 rounded-full gradient-gold border-0 text-brand-navy font-bold text-lg hover:shadow-gold transition-all hover:-translate-y-0.5">
                Buy Now
              </Button>
            </div>
